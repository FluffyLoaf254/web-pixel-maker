...
const colorStyle = (color?: Color) => {
  if (!color) {
    return 'background-position: 0 0, 0 0.5rem; background-size: 1rem 0.5rem, 1rem 0.5rem; background-repeat: repeat-x; background-image: linear-gradient(to right, #f0f0f0 0, #f0f0f0 50%, #c0c0c0 50%, #c0c0c0 100%), linear-gradient(to left, #f0f0f0 0, #f0f0f0 50%, #c0c0c0 50%, #c0c0c0 100%);';
  }
